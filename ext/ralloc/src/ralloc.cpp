...
void RP_set_tid(int tid) { Ralloc::set_tid(tid); }

void RP_simulate_crash() { _holder.ralloc_instance->simulate_crash(); }

void* RP_malloc(size_t sz) { return _holder.ralloc_instance->allocate(sz); }

void RP_free(void* ptr) { _holder.ralloc_instance->deallocate(ptr); }
...
int RP_in_prange(void* ptr) { return _holder.ralloc_instance->in_range(ptr); }
