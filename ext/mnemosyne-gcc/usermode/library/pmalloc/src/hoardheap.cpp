...
size_t hoardHeap::_sizeTable[hoardHeap::SIZE_CLASSES] = {
    8UL,          16UL,        24UL,        32UL,        40UL,
    48UL,         56UL,        64UL,        72UL,        80UL,
    88UL,         96UL,        104UL,       112UL,       120UL,
    128UL,        136UL,       144UL,       152UL,       160UL,
    168UL,        176UL,       184UL,       192UL,       200UL,
    208UL,        216UL,       224UL,       232UL,       240UL,
    248UL,        256UL,       264UL,       272UL,       280UL,
    288UL,        296UL,       304UL,       312UL,       320UL,
    328UL,        336UL,       344UL,       352UL,       360UL,
    368UL,        376UL,       384UL,       392UL,       400UL,
    408UL,        416UL,       424UL,       432UL,       440UL,
    448UL,        456UL,       464UL,       472UL,       480UL,
    488UL,        496UL,       504UL,       512UL,       576UL,
    640UL,        704UL,       768UL,       832UL,       896UL,
    960UL,        1024UL,      1088UL,      1152UL,      1216UL,
    1280UL,       1344UL,      1408UL,      1472UL,      1536UL,
    1600UL,       1664UL,      1728UL,      1792UL,      1856UL,
    1920UL,       1984UL,      2048UL,      2112UL,      2560UL,
    3072UL,       3584UL,      4096UL,      4608UL,      5120UL,
    5632UL,       6144UL,      6656UL,      7168UL,      7680UL,
    8192UL,       8704UL,      9216UL,      9728UL,      10240UL,
    10752UL,      12288UL,     16384UL,     20480UL,     24576UL,
    28672UL,      32768UL,     36864UL,     40960UL,     65536UL,
    98304UL,      131072UL,    163840UL,    262144UL,    524288UL,
    1048576UL,    2097152UL,   4194304UL,   8388608UL,   16777216UL,
    33554432UL,   67108864UL,  134217728UL, 268435456UL, 536870912UL,
    1073741824UL, 2147483648UL};

size_t hoardHeap::_threshold[hoardHeap::SIZE_CLASSES] = {
    2048UL, 1024UL, 682UL, 512UL, 409UL, 341UL, 292UL, 256UL, 227UL, 204UL,
    186UL,  170UL,  157UL, 146UL, 136UL, 128UL, 120UL, 113UL, 107UL, 102UL,
    97UL,   93UL,   89UL,  85UL,  81UL,  78UL,  75UL,  73UL,  70UL,  68UL,
    66UL,   64UL,   62UL,  60UL,  58UL,  56UL,  55UL,  53UL,  52UL,  51UL,
    49UL,   48UL,   47UL,  46UL,  45UL,  44UL,  43UL,  42UL,  41UL,  40UL,
    40UL,   39UL,   38UL,  37UL,  37UL,  36UL,  35UL,  35UL,  34UL,  34UL,
    33UL,   33UL,   32UL,  32UL,  28UL,  25UL,  23UL,  21UL,  19UL,  18UL,
    17UL,   16UL,   15UL,  14UL,  13UL,  12UL,  12UL,  11UL,  11UL,  10UL,
    10UL,   9UL,    9UL,   9UL,   8UL,   8UL,   8UL,   8UL,   7UL,   6UL,
    5UL,    4UL,    4UL,   3UL,   3UL,   2UL,   2UL,   2UL,   2UL,   2UL,
    2UL,    1UL,    1UL,   1UL,   1UL,   1UL,   1UL,   1UL,   1UL,   1UL,
...
__TM_CALLABLE__
superblock *hoardHeap::findAvailableSuperblock(int sizeclass, block *&b,
    ...
    for (int i = _leastEmptyBin[sizeclass]; i >= 0; i--) {
        ...
        if (sb == NULL) {
            // Check whether the persistent heap has a superblock of fullness i
            // and size class sizeclass available.
            ...
            if (sb->getOwner() != this) {
                fprintf(stderr,
                        "FAIL(124) %lf %d this = %p, sb = %p, sb->getOwner() = "
                        "%p\n",
                        ({
                            gettimeofday(&mtm_time, NULL);
                            (double)mtm_time.tv_sec +
    ...
    if (sb == NULL) {
        ...
        if (sb) {
            if (sb->getOwner() != this) {
                fprintf(stderr,
                        "FAIL(141) %lf %d this = %p, sb = %p, sb->getOwner() = "
                        "%p\n",
                        ({
                            gettimeofday(&mtm_time, NULL);
                            (double)mtm_time.tv_sec +
    ...
    if (sb != NULL) {
        ...
        if (sb->getOwner() != this) {
            fprintf(
                stderr,
                "FAIL(160) %lf %d this = %p, sb = %p, sb->getOwner() = %p\n", ({
                    gettimeofday(&mtm_time, NULL);
                    (double)mtm_time.tv_sec +
                        ((double)mtm_time.tv_usec / 1000000);
                }),
...
__TM_CALLABLE__
void hoardHeap::insertSuperblock(int sizeclass, superblock *sb,
                                 persistentHeap *persistentheap) {
    __m_debug();
    assert(sb->isValid());
    ...
    if ((fullness == 0) && (sb->getNumBlocks() > 1) &&
...
void hoardHeap::printSuperblockList() {
    ...
    for (int i = 0; i < 9; i--) {
        ...
        if (sb) {
            ...
            std::cout << "  ->psb: " << sb->getPersistentSuperblock()
                      << std::endl;
        }
    }
}
...
superblock *hoardHeap::removeMaxSuperblock(int sizeclass) {
    ...
    if (head) {
        ...
        // stats accordingly.
        decStats(sizeclass, 0, head->getNumBlocks());
        return head;
    }
...
superblock *hoardHeap::removePartiallyFullSuperblock(int fullness,
                                                     int sizeclass) {
    __m_debug();
    lock();
    assert(_magic == HEAP_MAGIC);
...
void hoardHeap::removeSuperblock(superblock *sb, int sizeclass) {
    assert(_magic == HEAP_MAGIC);
...
void hoardHeap::moveSuperblock(superblock *sb, int sizeclass, int fromBin,
                               int toBin) {
    assert(_magic == HEAP_MAGIC);
    assert(sb->isValid());
    assert(sb->getOwner() == this);
...
int hoardHeap::freeBlock(block *&b, superblock *&sb, int sizeclass,
                         persistentHeap *persistentheap) {
    assert(sb->isValid());
    assert(b->isValid());
    ...
    if (sb->getNumBlocks() == 1) {
        // TODO: currently our persistent allocator handles blocks of size
        // smaller that superblock size
        assert(0);
...
#endif
#if HEAP_FRAG_STATS
        persistentheap->setDeallocated(
            0, sb->getNumBlocks() * sizeFromClass(sb->getBlockSizeClass()));
#endif
...
hoardHeap::_initNumProcs::_initNumProcs(void) {
    ...
    hoardHeap::_numProcessorsMask =
        (1 << (lg(hoardGetNumProcessors()) + 4)) - 1;
