...
PersistentFactory::~PersistentFactory() { factory_map.clear(); }
...
void PersistentFactory::vTableUpdate(uint64_t type_id,
                                     PersistentObject* obj_ptr) {
    PersistentFactory& me = singleton();
