...
int main(int argc, char *argv[]) {
    ...
    auto r = pop.root();
    {
        ...
        try {
            ...
            nvobj::transaction::run(pop, [&] {
                nvobj::persistent_ptr<C> tmp1 = nvobj::make_persistent<C>(
                    a1, a1 + sizeof(a1) / sizeof(a1[0]));
                nvobj::persistent_ptr<C> tmp2 = nvobj::make_persistent<C>(
                    a2, a2 + sizeof(a2) / sizeof(a2[0]));
                UT_ASSERT(*r->c1 == *tmp2);
                UT_ASSERT(*r->c2 == *tmp1);
    ...
    }
    {
        ...
        try {
            ...
            nvobj::transaction::run(pop, [&] {
                ...
                UT_ASSERT(std::distance(r->c2->begin(), r->c2->end()) == 0);
                nvobj::delete_persistent<C>(tmp1);
            });
    ...
    }
    {
        ...
        try {
            ...
            UT_ASSERT(std::distance(r->c1->begin(), r->c1->end()) == 0);
