...
//   operator+(const charT* lhs, const basic_string<charT,traits,Allocator>&
//   rhs);
...
int main() {
    {
        ...
        test0("abcdefghijklmnopqrst", S("12345"),
...
#if TEST_STD_VER >= 11
    {
        ...
        test1("abcde", S("12345678901234567890"),
              S("abcde12345678901234567890"));
        ...
        test1("abcdefghijklmnopqrst", S("12345"),
              S("abcdefghijklmnopqrst12345"));
