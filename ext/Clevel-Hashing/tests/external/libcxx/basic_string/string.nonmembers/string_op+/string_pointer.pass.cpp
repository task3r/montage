...
//   operator+(const basic_string<charT,traits,Allocator>& lhs, const charT*
//   rhs);
...
int main() {
    {
        ...
        test0(S("abcde"), "12345678901234567890",
        ...
        test0(S("abcdefghijklmnopqrst"), "12345",
...
#if TEST_STD_VER >= 11
    {
        ...
        test1(S("abcde"), "12345678901234567890",
              S("abcde12345678901234567890"));
        ...
        test1(S("abcdefghijklmnopqrst"), "12345",
              S("abcdefghijklmnopqrst12345"));
