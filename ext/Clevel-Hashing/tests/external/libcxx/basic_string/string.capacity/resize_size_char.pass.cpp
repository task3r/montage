    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[8] = nvobj::make_persistent<S>("1234567890");
                s_arr[9] = nvobj::make_persistent<S>(
                    "12345678901234567890123456789012345678901234567890aaaaaaaa"
                    "aa");
                s_arr[10] = nvobj::make_persistent<S>("not going to happen");
