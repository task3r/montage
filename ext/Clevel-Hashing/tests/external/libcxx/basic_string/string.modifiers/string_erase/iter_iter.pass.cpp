    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[13] = nvobj::make_persistent<S>("abcdefghij");
                s_arr[14] = nvobj::make_persistent<S>("bcdefghij");
                s_arr[15] = nvobj::make_persistent<S>("fghij");
                s_arr[16] = nvobj::make_persistent<S>("j");
                s_arr[17] = nvobj::make_persistent<S>("acdefghij");
                s_arr[18] = nvobj::make_persistent<S>("afghij");
                s_arr[19] = nvobj::make_persistent<S>("aj");
                ;
                s_arr[20] = nvobj::make_persistent<S>("abcdeghij");
                s_arr[21] = nvobj::make_persistent<S>("abcdehij");
                s_arr[22] = nvobj::make_persistent<S>("abcdej");
                s_arr[23] = nvobj::make_persistent<S>("abcdefghi");

                s_arr[24] = nvobj::make_persistent<S>("abcdefghijklmnopqrst");
                s_arr[25] = nvobj::make_persistent<S>("bcdefghijklmnopqrst");
                s_arr[26] = nvobj::make_persistent<S>("klmnopqrst");
                s_arr[27] = nvobj::make_persistent<S>("t");
                s_arr[28] = nvobj::make_persistent<S>("acdefghijklmnopqrst");
                s_arr[29] = nvobj::make_persistent<S>("aklmnopqrst");
                s_arr[30] = nvobj::make_persistent<S>("at");
                s_arr[31] = nvobj::make_persistent<S>("abcdefghijlmnopqrst");
                s_arr[32] = nvobj::make_persistent<S>("abcdefghijpqrst");
                s_arr[33] = nvobj::make_persistent<S>("abcdefghijt");
                s_arr[34] = nvobj::make_persistent<S>("abcdefghijklmnopqrs");
                ...
                s_arr[42] = nvobj::make_persistent<S>(
                    "0123456789123456789012345678901234567890123456789012345678"
                    "90123456789");
                s_arr[43] = nvobj::make_persistent<S>(
                    "0123456789567890123456789012345678901234567890123456789012"
                    "3456789");
                s_arr[44] = nvobj::make_persistent<S>(
                    "0123456789901234567890123456789012345678901234567890123456"
                    "789");
