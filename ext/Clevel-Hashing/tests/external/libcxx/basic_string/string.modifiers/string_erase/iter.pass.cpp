    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[5] = nvobj::make_persistent<S>("abcdefghij");
                s_arr[6] = nvobj::make_persistent<S>("bcdefghij");
                s_arr[7] = nvobj::make_persistent<S>("acdefghij");
                s_arr[8] = nvobj::make_persistent<S>("abcdeghij");
                s_arr[9] = nvobj::make_persistent<S>("abcdefghi");

                s_arr[10] = nvobj::make_persistent<S>("abcdefghijklmnopqrst");
                s_arr[11] = nvobj::make_persistent<S>("bcdefghijklmnopqrst");
                s_arr[12] = nvobj::make_persistent<S>("acdefghijklmnopqrst");
                s_arr[13] = nvobj::make_persistent<S>("abcdefghijlmnopqrst");
                s_arr[14] = nvobj::make_persistent<S>("abcdefghijklmnopqrs");
                ...
                s_arr[18] = nvobj::make_persistent<S>(
                    "0123456789012345678912345678901234567890123456789012345678"
                    "90123456789");
