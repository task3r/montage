...
template <class S>
void test(nvobj::pool<struct root> &pop, const S &s, typename S::size_type pos,
          typename S::size_type n, const S &expected) {
    auto r = pop.root();

    nvobj::transaction::run(pop, [&] { r->s0 = nvobj::make_persistent<S>(s); });
    ...
    nvobj::transaction::run(pop, [&] { nvobj::delete_persistent<S>(r->s0); });
}
...
template <class S>
void test(nvobj::pool<struct root> &pop, const S &s1, const S &expected) {
    auto r = pop.root();
    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[5] = nvobj::make_persistent<S>("abcdefghi");
                s_arr[6] = nvobj::make_persistent<S>("abcdefghij");
                s_arr[7] = nvobj::make_persistent<S>("abcdefghijklmnopqrs");
                s_arr[8] = nvobj::make_persistent<S>("abcdefghijklmnopqrst");
                s_arr[9] = nvobj::make_persistent<S>("abcdefghijlmnopqrst");
                s_arr[10] = nvobj::make_persistent<S>("abcdefghijpqrst");
                s_arr[11] = nvobj::make_persistent<S>("abcdefghijt");
                s_arr[12] = nvobj::make_persistent<S>("abcdeghij");
                s_arr[13] = nvobj::make_persistent<S>("abcdehij");
                ...
                s_arr[18] = nvobj::make_persistent<S>("acdefghij");
                s_arr[19] = nvobj::make_persistent<S>("acdefghijklmnopqrst");
                ...
                s_arr[24] = nvobj::make_persistent<S>("aklmnopqrst");
                s_arr[25] = nvobj::make_persistent<S>("at");
                s_arr[26] = nvobj::make_persistent<S>("bcde");
                s_arr[27] = nvobj::make_persistent<S>("bcdefghij");
                s_arr[28] = nvobj::make_persistent<S>("bcdefghijklmnopqrst");
                s_arr[29] = nvobj::make_persistent<S>("can't happen");
                ...
                s_arr[34] = nvobj::make_persistent<S>("klmnopqrst");
                ...
                s_arr[39] = nvobj::make_persistent<S>(
                    "0234567890123456789012345678901234567890123456789012345678"
                    "90123456789");
                s_arr[40] = nvobj::make_persistent<S>("0");
                s_arr[41] = nvobj::make_persistent<S>("09");
                s_arr[42] = nvobj::make_persistent<S>(
                    "0012345678901234567890123456789012345678901234567890123456"
                    "789");
