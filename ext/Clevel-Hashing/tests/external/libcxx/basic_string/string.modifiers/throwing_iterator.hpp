...
struct throwing_it {
    ...
    throwing_it(const throwing_it &rhs)
        : begin_(rhs.begin_),
          ...
          action_(rhs.action_),
          index_(rhs.index_) {}
    throwing_it &operator=(const throwing_it &rhs) {
    ...
    bool operator==(const throwing_it &rhs) const {
    ...
    bool operator!=(const throwing_it &rhs) const { return !(*this == rhs); }
