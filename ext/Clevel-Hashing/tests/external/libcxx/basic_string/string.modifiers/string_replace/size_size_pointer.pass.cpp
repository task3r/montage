...
void test0() {
    ...
    test(S("abcde"), 0, 1, "12345678901234567890",
    ...
    test(S("abcde"), 0, 2, "12345678901234567890",
    ...
    test(S("abcde"), 1, 1, "12345678901234567890",
    ...
    test(S("abcde"), 1, 2, "12345678901234567890",
    ...
    test(S("abcde"), 2, 1, "12345678901234567890",
    ...
    test(S("abcde"), 2, 2, "12345678901234567890",
    ...
    test(S("abcde"), 4, 1, "12345678901234567890",
    ...
    test(S("abcde"), 4, 2, "12345678901234567890",
         S("abcd12345678901234567890"));
...
void test2() {
    ...
    test(S("abcdefghijklmnopqrst"), 0, 1, "12345",
    ...
    test(S("abcdefghijklmnopqrst"), 1, 1, "12345",
