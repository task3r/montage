...
void test1() {
    ...
    test(S("abcdefghijklmnopqrst"), 0, 0, 5, '3',
         S("33333abcdefghijklmnopqrst"));
    ...
    test(S("abcdefghijklmnopqrst"), 0, 1, 5, '3',
         S("33333bcdefghijklmnopqrst"));
    ...
    test(S("abcdefghijklmnopqrst"), 1, 0, 5, '3',
         S("a33333bcdefghijklmnopqrst"));
    ...
    test(S("abcdefghijklmnopqrst"), 1, 1, 5, '3',
         S("a33333cdefghijklmnopqrst"));
    ...
    test(S("abcdefghijklmnopqrst"), 1, 18, 20, '3',
         S("a33333333333333333333t"));
    ...
    test(S("abcdefghijklmnopqrst"), 10, 1, 5, '3',
         S("abcdefghij33333lmnopqrst"));
...
void test2() {
    ...
    test(S("abcdefghijklmnopqrst"), 19, 1, 5, '3',
         S("abcdefghijklmnopqrs33333"));
