...
// template <class T>
//    basic_string& assign(size_type pos1, const T& t, size_type pos2, size_type
//    n=npos); // C++17
//
...
void test1() {
    ...
    test(S(""), 0, SV("12345678901234567890"), 0, 20,
         S("12345678901234567890"));
    test(S(""), 0, SV("12345678901234567890"), 0, 21,
         S("12345678901234567890"));
...
template <class S, class SV>
void test4() {
    test(S("abcde"), 0, SV("12345678901234567890"), 0, 10,
         S("1234567890abcde"));
    ...
    test(S("abcde"), 0, SV("12345678901234567890"), 10, 10,
         S("1234567890abcde"));
    test(S("abcde"), 0, SV("12345678901234567890"), 10, 11,
         S("1234567890abcde"));
...
void test5() {
    ...
    test(S("abcde"), 1, SV("12345678901234567890"), 0, 10,
         S("a1234567890bcde"));
    ...
    test(S("abcde"), 1, SV("12345678901234567890"), 10, 10,
         S("a1234567890bcde"));
    test(S("abcde"), 1, SV("12345678901234567890"), 10, 11,
         S("a1234567890bcde"));
...
void test6() {
    ...
    test(S("abcde"), 2, SV("12345678901234567890"), 0, 10,
         S("ab1234567890cde"));
...
void test7() {
    ...
    test(S("abcde"), 2, SV("12345678901234567890"), 10, 10,
         S("ab1234567890cde"));
    test(S("abcde"), 2, SV("12345678901234567890"), 10, 11,
         S("ab1234567890cde"));
...
void test8() {
    ...
    test(S("abcde"), 4, SV("12345678901234567890"), 0, 10,
         S("abcd1234567890e"));
    ...
    test(S("abcde"), 4, SV("12345678901234567890"), 10, 10,
         S("abcd1234567890e"));
    test(S("abcde"), 4, SV("12345678901234567890"), 10, 11,
         S("abcd1234567890e"));
...
void test9() {
    ...
    test(S("abcde"), 5, SV("12345678901234567890"), 0, 10,
         S("abcde1234567890"));
...
void test10() {
    ...
    test(S("abcde"), 5, SV("12345678901234567890"), 10, 10,
         S("abcde1234567890"));
    test(S("abcde"), 5, SV("12345678901234567890"), 10, 11,
         S("abcde1234567890"));
...
void test12() {
    ...
    test(S("abcdefghij"), 0, SV("1234567890"), 0, 10,
         S("1234567890abcdefghij"));
    test(S("abcdefghij"), 0, SV("1234567890"), 0, 11,
         S("1234567890abcdefghij"));
    ...
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 0, 1,
         S("1abcdefghij"));
    ...
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 1, 1,
         S("2abcdefghij"));
}
...
void test13() {
    ...
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 1, 20,
         S("2345678901234567890abcdefghij"));
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 10, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 10, 1,
         S("1abcdefghij"));
    ...
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 10, 11,
         S("1234567890abcdefghij"));
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 19, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 19, 1,
         S("0abcdefghij"));
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 19, 2,
         S("0abcdefghij"));
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 20, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 0, SV("12345678901234567890"), 20, 1,
         S("abcdefghij"));
    ...
    test(S("abcdefghij"), 1, SV("1234567890"), 0, 10,
         S("a1234567890bcdefghij"));
    test(S("abcdefghij"), 1, SV("1234567890"), 0, 11,
         S("a1234567890bcdefghij"));
...
void test14() {
    ...
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 0, 1,
         S("a1bcdefghij"));
    ...
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 1, 1,
         S("a2bcdefghij"));
    ...
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 1, 20,
         S("a2345678901234567890bcdefghij"));
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 10, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 10, 1,
         S("a1bcdefghij"));
    ...
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 10, 11,
         S("a1234567890bcdefghij"));
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 19, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 19, 1,
         S("a0bcdefghij"));
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 19, 2,
         S("a0bcdefghij"));
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 20, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 1, SV("12345678901234567890"), 20, 1,
         S("abcdefghij"));
...
void test15() {
    ...
    test(S("abcdefghij"), 5, SV("1234567890"), 0, 10,
         S("abcde1234567890fghij"));
    test(S("abcdefghij"), 5, SV("1234567890"), 0, 11,
         S("abcde1234567890fghij"));
    ...
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 0, 1,
         S("abcde1fghij"));
    ...
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 1, 1,
         S("abcde2fghij"));
...
void test16() {
    ...
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 1, 20,
         S("abcde2345678901234567890fghij"));
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 10, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 10, 1,
         S("abcde1fghij"));
    ...
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 10, 11,
         S("abcde1234567890fghij"));
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 19, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 19, 1,
         S("abcde0fghij"));
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 19, 2,
         S("abcde0fghij"));
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 20, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 5, SV("12345678901234567890"), 20, 1,
         S("abcdefghij"));
    ...
    test(S("abcdefghij"), 9, SV("1234567890"), 0, 10,
         S("abcdefghi1234567890j"));
    test(S("abcdefghij"), 9, SV("1234567890"), 0, 11,
         S("abcdefghi1234567890j"));
...
void test17() {
    ...
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 0, 1,
         S("abcdefghi1j"));
    ...
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 1, 1,
         S("abcdefghi2j"));
    ...
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 1, 20,
         S("abcdefghi2345678901234567890j"));
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 10, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 10, 1,
         S("abcdefghi1j"));
    ...
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 10, 11,
         S("abcdefghi1234567890j"));
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 19, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 19, 1,
         S("abcdefghi0j"));
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 19, 2,
         S("abcdefghi0j"));
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 20, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 9, SV("12345678901234567890"), 20, 1,
         S("abcdefghij"));
...
void test18() {
    ...
    test(S("abcdefghij"), 10, SV("1234567890"), 0, 10,
         S("abcdefghij1234567890"));
    test(S("abcdefghij"), 10, SV("1234567890"), 0, 11,
         S("abcdefghij1234567890"));
    ...
    test(S("abcdefghij"), 10, SV("1234567890"), 1, 10,
    ...
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 0, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 0, 1,
         S("abcdefghij1"));
    ...
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 0, 21,
         S("abcdefghij12345678901234567890"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 1, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 1, 1,
         S("abcdefghij2"));
...
template <class S, class SV>
void test19() {
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 10, 0,
         S("abcdefghij"));
    ...
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 10, 11,
         S("abcdefghij1234567890"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 19, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 19, 1,
         S("abcdefghij0"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 19, 2,
         S("abcdefghij0"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 20, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 10, SV("12345678901234567890"), 20, 1,
         S("abcdefghij"));
...
void test23() {
    ...
    test(S("abcdefghijklmnopqrst"), 1, SV("12345678901234567890"), 21, 0,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 10, SV(""), 0, 0,
         S("abcdefghijklmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 10, SV(""), 0, 1,
         S("abcdefghijklmnopqrst"));
...
void test25() {
    ...
    test(S("abcdefghijklmnopqrst"), 10, SV("12345678901234567890"), 21, 0,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 19, SV(""), 0, 0,
         S("abcdefghijklmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 19, SV(""), 0, 1,
         S("abcdefghijklmnopqrst"));
...
void test26() {
    ...
    test(S("abcdefghijklmnopqrst"), 19, SV("12345678901234567890"), 21, 0,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 20, SV(""), 0, 0,
         S("abcdefghijklmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 20, SV(""), 0, 1,
         S("abcdefghijklmnopqrst"));
...
template <class S, class SV>
void test30() {
    test_npos(S(""), 0, SV("12345678901234567890"), 0,
              S("12345678901234567890"));
    test_npos(S(""), 0, SV("12345678901234567890"), 1,
