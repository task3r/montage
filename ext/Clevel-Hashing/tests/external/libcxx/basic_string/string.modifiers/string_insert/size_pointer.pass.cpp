...
int main() {
    {
        ...
        test(S("abcde"), 1, "12345678901234567890",
        ...
        test(S("abcde"), 2, "12345678901234567890",
        ...
        test(S("abcde"), 4, "12345678901234567890",
        ...
        test(S("abcde"), 5, "12345678901234567890",
        ...
        test(S("abcdefghijklmnopqrst"), 0, "12345",
        ...
        test(S("abcdefghijklmnopqrst"), 1, "12345",
