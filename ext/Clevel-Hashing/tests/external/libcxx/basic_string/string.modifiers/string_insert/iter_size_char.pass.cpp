...
int main() {
    {
        ...
        test(S("abcdefghijklmnopqrst"), 0, 5, '1',
             S("11111abcdefghijklmnopqrst"));
        ...
        test(S("abcdefghijklmnopqrst"), 1, 5, '1',
             S("a11111bcdefghijklmnopqrst"));
        ...
        test(S("abcdefghijklmnopqrst"), 10, 5, '1',
             S("abcdefghij11111klmnopqrst"));
        ...
        test(S("abcdefghijklmnopqrst"), 19, 5, '1',
             S("abcdefghijklmnopqrs11111t"));
        ...
        test(S("abcdefghijklmnopqrst"), 20, 5, '1',
             S("abcdefghijklmnopqrst11111"));
