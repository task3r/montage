...
void test4() {
    ...
    test(S("abcde"), 0, S("12345678901234567890"), 10, 10,
         S("1234567890abcde"));
    test(S("abcde"), 0, S("12345678901234567890"), 10, 11,
         S("1234567890abcde"));
...
void test5() {
    ...
    test(S("abcde"), 1, S("12345678901234567890"), 10, 10,
         S("a1234567890bcde"));
    test(S("abcde"), 1, S("12345678901234567890"), 10, 11,
         S("a1234567890bcde"));
...
void test7() {
    ...
    test(S("abcde"), 2, S("12345678901234567890"), 10, 10,
         S("ab1234567890cde"));
    test(S("abcde"), 2, S("12345678901234567890"), 10, 11,
         S("ab1234567890cde"));
...
void test8() {
    ...
    test(S("abcde"), 4, S("12345678901234567890"), 10, 10,
         S("abcd1234567890e"));
    test(S("abcde"), 4, S("12345678901234567890"), 10, 11,
         S("abcd1234567890e"));
...
void test10() {
    ...
    test(S("abcde"), 5, S("12345678901234567890"), 10, 10,
         S("abcde1234567890"));
    test(S("abcde"), 5, S("12345678901234567890"), 10, 11,
         S("abcde1234567890"));
...
void test13() {
    ...
    test(S("abcdefghij"), 0, S("12345678901234567890"), 10, 1,
         S("1abcdefghij"));
    ...
    test(S("abcdefghij"), 0, S("12345678901234567890"), 19, 1,
         S("0abcdefghij"));
    test(S("abcdefghij"), 0, S("12345678901234567890"), 19, 2,
         S("0abcdefghij"));
    test(S("abcdefghij"), 0, S("12345678901234567890"), 20, 0, S("abcdefghij"));
    test(S("abcdefghij"), 0, S("12345678901234567890"), 20, 1, S("abcdefghij"));
    test(S("abcdefghij"), 0, S("12345678901234567890"), 21, 0,
         S("can't happen"));
...
void test14() {
    ...
    test(S("abcdefghij"), 1, S("12345678901234567890"), 10, 1,
         S("a1bcdefghij"));
    ...
    test(S("abcdefghij"), 1, S("12345678901234567890"), 19, 1,
         S("a0bcdefghij"));
    test(S("abcdefghij"), 1, S("12345678901234567890"), 19, 2,
         S("a0bcdefghij"));
    test(S("abcdefghij"), 1, S("12345678901234567890"), 20, 0, S("abcdefghij"));
    test(S("abcdefghij"), 1, S("12345678901234567890"), 20, 1, S("abcdefghij"));
    test(S("abcdefghij"), 1, S("12345678901234567890"), 21, 0,
         S("can't happen"));
...
void test16() {
    ...
    test(S("abcdefghij"), 5, S("12345678901234567890"), 10, 1,
         S("abcde1fghij"));
    ...
    test(S("abcdefghij"), 5, S("12345678901234567890"), 19, 1,
         S("abcde0fghij"));
    test(S("abcdefghij"), 5, S("12345678901234567890"), 19, 2,
         S("abcde0fghij"));
    test(S("abcdefghij"), 5, S("12345678901234567890"), 20, 0, S("abcdefghij"));
    test(S("abcdefghij"), 5, S("12345678901234567890"), 20, 1, S("abcdefghij"));
    test(S("abcdefghij"), 5, S("12345678901234567890"), 21, 0,
         S("can't happen"));
...
void test17() {
    ...
    test(S("abcdefghij"), 9, S("12345678901234567890"), 10, 1,
         S("abcdefghi1j"));
    ...
    test(S("abcdefghij"), 9, S("12345678901234567890"), 19, 1,
         S("abcdefghi0j"));
    test(S("abcdefghij"), 9, S("12345678901234567890"), 19, 2,
         S("abcdefghi0j"));
    test(S("abcdefghij"), 9, S("12345678901234567890"), 20, 0, S("abcdefghij"));
    test(S("abcdefghij"), 9, S("12345678901234567890"), 20, 1, S("abcdefghij"));
    test(S("abcdefghij"), 9, S("12345678901234567890"), 21, 0,
         S("can't happen"));
...
void test18() {
    ...
    test(S("abcdefghij"), 10, S("1234567890"), 0, 10,
         S("abcdefghij1234567890"));
    test(S("abcdefghij"), 10, S("1234567890"), 0, 11,
         S("abcdefghij1234567890"));
    ...
    test(S("abcdefghij"), 10, S("12345678901234567890"), 0, 1,
         S("abcdefghij1"));
    ...
    test(S("abcdefghij"), 10, S("12345678901234567890"), 1, 1,
         S("abcdefghij2"));
...
template <class S>
void test19() {
    test(S("abcdefghij"), 10, S("12345678901234567890"), 10, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 10, S("12345678901234567890"), 10, 1,
         S("abcdefghij1"));
    ...
    test(S("abcdefghij"), 10, S("12345678901234567890"), 10, 11,
         S("abcdefghij1234567890"));
    test(S("abcdefghij"), 10, S("12345678901234567890"), 19, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 10, S("12345678901234567890"), 19, 1,
         S("abcdefghij0"));
    test(S("abcdefghij"), 10, S("12345678901234567890"), 19, 2,
         S("abcdefghij0"));
    test(S("abcdefghij"), 10, S("12345678901234567890"), 20, 0,
         S("abcdefghij"));
    test(S("abcdefghij"), 10, S("12345678901234567890"), 20, 1,
         S("abcdefghij"));
...
void test20() {
    ...
    test(S("abcdefghij"), 11, S("12345678901234567890"), 0, 0,
         S("can't happen"));
    test(S("abcdefghij"), 11, S("12345678901234567890"), 0, 1,
         S("can't happen"));
    ...
    test(S("abcdefghij"), 11, S("12345678901234567890"), 0, 21,
         S("can't happen"));
    test(S("abcdefghij"), 11, S("12345678901234567890"), 1, 0,
         S("can't happen"));
    test(S("abcdefghij"), 11, S("12345678901234567890"), 1, 1,
         S("can't happen"));
    test(S("abcdefghij"), 11, S("12345678901234567890"), 1, 9,
         S("can't happen"));
...
void test21() {
    ...
    test(S("abcdefghijklmnopqrst"), 0, S("1234567890"), 10, 1,
         S("abcdefghijklmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 0, S("1234567890"), 11, 0,
         S("can't happen"));
...
void test23() {
    ...
    test(S("abcdefghijklmnopqrst"), 1, S("1234567890"), 10, 1,
         S("abcdefghijklmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 1, S("1234567890"), 11, 0,
         S("can't happen"));
...
void test28() {
    ...
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 0, 0,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 0, 1,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 0, 5,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 0, 9,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 0, 10,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 0, 11,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 1, 0,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 1, 1,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 1, 4,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 1, 8,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 1, 9,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 1, 10,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 5, 0,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 5, 1,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 5, 2,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 5, 4,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 5, 5,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 5, 6,
         S("can't happen"));
}

template <class S>
void test29() {
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 9, 0,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 9, 1,
         S("can't happen"));
    test(S("abcdefghijklmnopqrst"), 21, S("1234567890"), 9, 2,
         S("can't happen"));
...
template <class S>
void test30() {
    test_npos(S(""), 0, S("12345678901234567890"), 0,
