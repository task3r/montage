    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[5] = nvobj::make_persistent<S>("1234567890");
                s_arr[6] = nvobj::make_persistent<S>("12345678901234567890");
            ...
            test(pop, *s_arr[0], "12345678901234567890", 1, *s_arr[1]);
            test(pop, *s_arr[0], "12345678901234567890", 3, *s_arr[2]);
            test(pop, *s_arr[0], "12345678901234567890", 20, *s_arr[6]);
            test(pop, *s_arr[0],
            ...
            test(pop, *s_arr[6], "12345678901234567890", 20, *s_arr[6]);
    ...
    }
    {
        {  // test assignment to self
            try {
                ...
                UT_ASSERT(s_long == "Lorem ipsum dolor sit amet, consectetur/");
