    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[6] = nvobj::make_persistent<S>("12345aaaaaaaaaa");

                s_arr[7] = nvobj::make_persistent<S>("12345678901234567890");
                s_arr[8] = nvobj::make_persistent<S>("12345678901234567890a");
                s_arr[9] =
                    nvobj::make_persistent<S>("12345678901234567890aaaaaaaaaa");
