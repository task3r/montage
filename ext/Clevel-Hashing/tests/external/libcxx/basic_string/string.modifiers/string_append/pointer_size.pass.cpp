    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[6] = nvobj::make_persistent<S>("1234512345");
                s_arr[7] = nvobj::make_persistent<S>("123451234567890");
                s_arr[8] =
                    nvobj::make_persistent<S>("1234567890123456789012345");
            ...
            test(pop, *s_arr[0], "12345678901234567890", 0, *s_arr[0]);
            test(pop, *s_arr[0], "12345678901234567890", 1, *s_arr[5]);
            test(pop, *s_arr[0], "12345678901234567890", 3, *s_arr[1]);
            test(pop, *s_arr[0], "12345678901234567890", 20, *s_arr[4]);
            ...
            test(pop, *s_arr[4], "12345678901234567890", 20, *s_arr[9]);

            test(pop, *s_arr[10], "", 0, *s_arr[10]);
            test(pop, *s_arr[10], "67890", 5, *s_arr[11]);
            test(pop, *s_arr[9], "1234567890123456789012345", 25, *s_arr[10]);
            ...
            s_extra_long.append(s_extra_long.data(), s_extra_long.size());
            UT_ASSERT(s_extra_long ==
