    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[4] = nvobj::make_persistent<S>("1234512345");
                s_arr[5] = nvobj::make_persistent<S>("123451234567890");
                s_arr[6] =
                    nvobj::make_persistent<S>("1234512345678901234567890");
                s_arr[7] = nvobj::make_persistent<S>("123456789012345");
                s_arr[8] =
                    nvobj::make_persistent<S>("123456789012345678901234567890");
                s_arr[9] = nvobj::make_persistent<S>("12345678901234567890");
                s_arr[10] =
