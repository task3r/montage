...
template <class S>
void test(nvobj::pool<struct root> &pop, const S &s1, const S &str,
...
template <class S>
void test_npos(nvobj::pool<struct root> &pop, const S &s1, const S &str,
    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[11] = nvobj::make_persistent<S>("1234534");
                s_arr[12] = nvobj::make_persistent<S>("123451234567890");
                s_arr[13] =
                    nvobj::make_persistent<S>("12345678901234567890234");
                s_arr[14] =
                    nvobj::make_persistent<S>("123456789012345678906789012345");
                s_arr[15] = nvobj::make_persistent<S>("1234567890");
