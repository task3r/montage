    ...
    auto r = pop.root();
    {
        ...
        try {
            nvobj::transaction::run(pop, [&] {
                ...
                s_arr[2] = nvobj::make_persistent<S>("12345678901234567890");
                s_arr[3] = nvobj::make_persistent<S>("1234512345");
                s_arr[4] = nvobj::make_persistent<S>("123451234567890");
                s_arr[5] =
            ...
            test(pop, *s_arr[6], "1234567890123456789012345", *s_arr[7]);
