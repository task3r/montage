...
template <class S, class U>
void test0(pmem::obj::persistent_ptr<root> &r, const std::array<U, 4> &arr) {
...
template <class S, class U>
void test1(pmem::obj::persistent_ptr<root> &r, const std::array<U, 4> &arr) {
...
template <class S, class U>
void test2(pmem::obj::persistent_ptr<root> &r, const std::array<U, 4> &arr) {
...
void run(pmem::obj::pool<root> &pop) {
    ...
    try {
        nvobj::transaction::run(pop, [&] {
            ...
            r->s4 = nvobj::make_persistent<S>("abcdefghijklmnopqrst");
        });
...
int main(int argc, char *argv[]) {
    ...
    try {
        pop = pmem::obj::pool<root>::create(
            path, "basic_string", PMEMOBJ_MIN_POOL, S_IWUSR | S_IRUSR);
    } catch (...) {
