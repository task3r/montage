...
template <class S>
void test0(pmem::obj::pool<root> &pop) {
    auto r = pop.root();
...
template <class S>
void test1(pmem::obj::pool<root> &pop) {
    auto r = pop.root();
...
template <class S>
void test2(pmem::obj::pool<root> &pop) {
    auto r = pop.root();
...
void run(pmem::obj::pool<root> &pop) {
    ...
    try {
        nvobj::transaction::run(pop, [&] {
            ...
            r->s2 = nvobj::make_persistent<pmem_exp::string>("abcde");
            r->s3 = nvobj::make_persistent<pmem_exp::string>("abcdefghij");
