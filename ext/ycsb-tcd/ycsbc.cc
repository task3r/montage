...
int main(const int argc, char *argv[]) {
    // TODO: include GlobalTestConfig, construct command line args, and
    // initialize EpochSys
    ...
    gtc.num_procs = hwloc_get_nbobjs_by_depth(
        gtc.topology, hwloc_get_type_depth(gtc.topology, HWLOC_OBJ_PU));
    ...
    actual_ops.emplace_back(
        async(launch::async, DelegateClient, db, &wl, total_ops, true, 0));
    // }
