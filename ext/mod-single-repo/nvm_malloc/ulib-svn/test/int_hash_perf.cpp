...
uint64_t rand_int_mix64_time() {
    ...
    for (i = 0; i < 100000000; ++i) RAND_INT_MIX64(k);
    return k;
}
...
uint64_t rand_int2_mix64_time() {
    ...
    for (i = 0; i < 100000000; ++i) RAND_INT2_MIX64(k);
    return k;
}
...
uint64_t rand_int3_mix64_time() {
    ...
    for (i = 0; i < 100000000; ++i) RAND_INT3_MIX64(k);
    return k;
}
...
uint64_t rand_int4_mix64_time() {
    ...
    for (i = 0; i < 100000000; ++i) RAND_INT4_MIX64(k);
    return k;
}
...
uint64_t fer_mix64_time() {
    ...
    for (i = 0; i < 100000000; ++i) FER_MIX64(k);
    return k;
}
