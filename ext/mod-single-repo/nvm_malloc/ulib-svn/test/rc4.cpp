...
const unsigned char test_key1[] = "Key";
// key stream for ASCII key "Key"
const unsigned char test_vec1[] = {0xeb, 0x9f, 0x77, 0x81, 0xb7, 0x34};

const unsigned char test_key2[] = "Wiki";
// key stream for ASCII key "Wiki"
const unsigned char test_vec2[] = {0x60, 0x44, 0xdb, 0x6d, 0x41, 0xb7};

const unsigned char test_key3[] = "Secret";
// key stream for ASCII key "Secret"
const unsigned char test_vec3[] = {0x04, 0xd4, 0x6b, 0x05, 0x3c, 0xa8};
