 ...
 */
#if IMMER_USE_NVM
// nvm_malloc maintains own free list and heap so no need for redundancy
// TODO: free list needs to be persistent?
using default_heap_policy = heap_policy<nvm_malloc_heap>;
#else
