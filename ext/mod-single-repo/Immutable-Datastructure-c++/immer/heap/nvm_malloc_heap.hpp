...
/*
static inline void print_stacktrace(FILE *out = stdout, unsigned int max_frames
= 63)
{
...
struct nvm_malloc_heap {
    ...
    static void* allocate(std::size_t size, Tags...) {
        ...
        //        std::cout << "Allocated:" << p << " (" << size << ")" <<
        //        std::endl; print_stacktrace();
        return p;
    }
    ...
    static void deallocate(std::size_t size, void* data) {
        //        std::cout << "Deallocated:" << data << " (" << size << ")" <<
        //        std::endl; print_stacktrace();
