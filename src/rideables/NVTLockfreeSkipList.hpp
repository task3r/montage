...
class NVTLockfreeSkipList : public RMap<K, V> {
   ...
   public:
    NVTLockfreeSkipList(int task_num) : tracker(task_num + 1, 100, 1000, true) {
        ...
        background_thread =
            std::move(std::thread(&NVTLockfreeSkipList::bg_loop, this, bg_tid));
    };
    ~NVTLockfreeSkipList() {
...
template <class K, class V>
void NVTLockfreeSkipList<K, V>::bg_help_remove(Node *prev, Node *node,
                                               int tid) {
...
template <class K, class V>
int NVTLockfreeSkipList<K, V>::internal_finish_contains(
...
template <class K, class V>
int NVTLockfreeSkipList<K, V>::internal_finish_delete(const K &key, Node *node,
...
template <class K, class V>
int NVTLockfreeSkipList<K, V>::internal_finish_insert(const K &key, V &val,
                                                      Node *node,
                                                      Payload *node_payload,
                                                      Node *next,
                                                      Payload *&lazy_payload) {
...
template <class K, class V>
bool NVTLockfreeSkipList<K, V>::internal_do_operation(operation_type optype,
                                                      const K &key,
                                                      optional<V> &val,
                                                      optional<V> &ret_value,
                                                      int tid) {
...
template <>
class NVTLockfreeSkipList<std::string, std::string>::Payload
    : public Persistent {
   public:
